...
>
  <form method="POST" action="?/deploy">
    <div class="-mx-3 mb-2">
      ...
      <button
        type="submit"
        class="bg-yellow-500 hover:bg-blue-700 text-white font-bold mt-5 ml-2 px-2 py-2 rounded"
      >
        Deploy bounty
      </button>
    </div>
  ...
  {#if form?.success}
    ...
    <p class="pt-2 text-green-600 font-semibold">Bounty was deployed successfully: <a hre={form?.tx}>Trasaction Link</a>!</p>
  {/if}
</div>